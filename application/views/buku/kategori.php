                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('buku/hapusKategori/').$k['id_kategori'];?>" onclick="return confirm('Kamu yakin akan menghapus Kategori <?= $k['nama_kategori'];''.$k['id_kategori'];?>?');" class="badge badge-danger">
